...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Farhan\n'
            + 'ORG:Creator FXC7;\n'
            + 'TEL;type=CELL;type=VOICE;waid=559888459627:+55 98 8845-9627\n'
            + 'END:VCARD'

prefix = "_"
name = "~ Driel | Totoso"
rdaftar = "OBRIGADO POR SE REGISTRAR😁"
rmenu = "Olá amigos do Adriel👋"
limitt = 50
ban = []
...
const getRegisteredRandomId = () => {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const FarhanGans = ["98988459627@s.whatsapp.net"] // apenas mude esta tudo bem
			...
			mess = {
				...
				only: {
					...
					benned: '*𝘀𝗲𝘂 𝗻u𝗺𝗲𝗿𝗼 𝘁a 𝗽𝗿𝗼𝗶𝗯𝗶𝗱𝗼 𝗱𝗲 𝘂𝘀𝗮𝗿 𝗼 𝗯𝗼𝘁 𝗰𝗼𝗻𝘁𝗮𝗰𝘁𝗲 COM ADRIEL*',
