...
\`\`\`INSTAGRAM OFFICIAL\`\`\`
https://www.instagram.com/adr3l.mp4/
...
│➻ *${prefix}igstalk _LEITE CONDESADO*
│➻ *${prefix}insta Link*
...
│➻ *${prefix}cglitch Driel/totoso*
│➻ *${prefix}cpubg Driel/totoso*
│➻ *${prefix}cml Driel*
│
│➻ *${prefix}tahta DRIEL*
│➻ *${prefix}croman DRIEL dan BOT*
│➻ *${prefix}cthunder DRIEL*
│➻ *${prefix}cbpink DRIEL*
│➻ *${prefix}cmwolf DRIEL*
│➻ *${prefix}csky DRIEL*
│➻ *${prefix}cwooden DRIEL*
│➻ *${prefix}cflower DRIEL*
│➻ *${prefix}clove DRIEL*
│➻ *${prefix}ccrossfire DRIEL*
│➻ *${prefix}cnaruto DRIEL*
│➻ *${prefix}cparty DRIEL*
│➻ *${prefix}cshadow DRIEL*
│➻ *${prefix}cminion DRIEL*
│➻ *${prefix}cneon CAFE*
│➻ *${prefix}cneon2 CAFE*
...
│➻ *${prefix}tts id Haii*
│➻ *${prefix}ttp Driel*
│➻ *${prefix}cballon Driel*
│➻ *${prefix}cpaper Driel*
│➻ *${prefix}slide Driel BOT WA*
│
│➻ *${prefix}stiker*
│➻ *${prefix}gifstiker*
│➻ *${prefix}toimg*
